...
public enum Config
{
    ...
    BROKER_DB_USERNAME               (UNIQUE,   NO_SUBLIST,  "broker.store.username",            STRING,    "noza"                               ),
    BROKER_DB_PASSWORD               (UNIQUE,   NO_SUBLIST,  "broker.store.password",            STRING,    "noza"                               ),
    BROKER_DB_PERSISTED              (UNIQUE,   NO_SUBLIST,  "broker.store.persisted",           BOOLEAN,   true                                 ),
    BROKER_DB_HOSTNAME               (UNIQUE,   NO_SUBLIST,  "broker.store.hostname",            STRING,    "127.0.0.1"                          ),
    BROKER_DB_PORT                   (UNIQUE,   NO_SUBLIST,  "broker.store.port",                INTEGER,   0                                    ),
